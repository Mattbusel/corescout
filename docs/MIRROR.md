...
**A machine-native, read-only representation of what a computer physically is,
right now.**

This is the primitive CoreScout was built on, and the part of the project that
